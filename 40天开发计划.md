...
| ERP 推单/关单 | ✅ | |
| 工单查询 + 状态机 | ✅ | |
| 派工全链路 D15~D21 | ✅ | API + 管理端/工人端 UI |
| 报工 D22~D26 | ✅ | 校验/幂等/MQ/消费落库/状态机/ERP 回传 |
| 报工 UI D27 | ✅ | `/terminal/report/:taskId` + 轮询 |
| 集成对账 D29~D31 | ✅ | API + 定时重试 + 管理端页 |
| QMS Mock D32 | ✅ | 不良自动建质检任务 |
| AOP 审计 D33 | ✅ | 派工/报工 |
| 种子 10 工单 D34 | ✅ | `mes_db.sql` |
| Compose + README D35~D36 | ✅ | 含 backend 镜像 |
| 面试讲稿 D38 | ✅ | `docs/面试讲稿.md` |
| 录屏/PPT D37/D40 | ⏸ | 需本人录制与答辩练习 |

**当前阶段**：主链路代码已齐；按 `docs/D28-自测清单.md` 自测即可。
